...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#02080d] px-5 py-8 text-slate-100 lg:px-10">
      <div className="mx-auto flex min-h-[calc(100vh-4rem)] w-full max-w-5xl flex-col justify-center">
        <section className="rounded-[2rem] border border-cyan-400/15 bg-[#04111a]/85 p-8 shadow-[0_30px_120px_rgba(0,0,0,0.45)] backdrop-blur">
          ...
          <h1 className="max-w-3xl text-4xl font-black tracking-[-0.04em] text-white lg:text-6xl">
            DeepAgents Control Tower
          </h1>
          <p className="mt-5 max-w-3xl text-base leading-7 text-slate-400">
            Clean, read-only access to the autonomous paper trading loop: agent chain,
            simulated orders, paper positions, learning outcomes, and alerts. Legacy
            workspaces have been moved out of this app surface.
          </p>
