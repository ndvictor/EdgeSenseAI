    ...
    <div className="min-h-screen bg-slate-500 p-4 lg:p-6">
      <div className="mx-auto w-full max-w-[1600px]">
        <PageHeader
          ...
          title="Stocks"
          description="Search and visualize stock price action, then validate candidates through feature, model, account, and risk workflows before they become actionable insights."
        />
          ...
          {!snapshot || !pipeline || !feasibility || !risk ? (
            ...
            <>
              <section className="rounded-xl border border-emerald-800 bg-slate-950 p-4 shadow-sm">
                <h2 className="mb-3 text-lg font-semibold text-emerald-500">Current Workflow Candidate: {snapshot.symbol}</h2>
