...
def embed_text(text: str) -> EmbeddingResult:
    warnings: list[str] = []
    if settings.embeddings_provider != "placeholder" and not settings.embeddings_enable_paid_calls:
    ...
    if settings.embeddings_provider != "placeholder" and settings.embeddings_enable_paid_calls:
...
def get_embedding_status() -> dict:
    return {
        ...
        "paid_calls_enabled": settings.embeddings_enable_paid_calls,
