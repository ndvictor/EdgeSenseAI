...
def get_data_sources_status():
    ...
    checks = {
        ...
        "tiingo": _env_status(settings.tiingo_api_key, "TIINGO_API_KEY is set.", "Tiingo is not configured."),
    ...
    source_specs = [
        ...
        ("Tiingo", "tiingo", "market_data", ["stocks", "eod_bars", "fundamentals", "news_optional"], ["fallback_market_data"]),
